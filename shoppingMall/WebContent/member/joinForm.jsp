...
<div class="titleArea"><h2>회원 가입</h2></div>

<form method="post" name="joinForm" id="joinForm" action="./join.do">
<div class="ec-base-table typeWrite xans-member-join">
...
<tr>
	...
	<td>
		<input type="text" id="member_id" name="member_id" class="inputTypeText">
		<span id="idMsg"></span> 
	</td>
</tr>
...
<tr>
	...
	<td>
		<input type="password" name="user_passwd_confirm" id="user_passwd_confirm" maxlength="16" >
		<span id="confirm_pwdMsg"></span>
	</td>
</tr>
...
<tr>
    ...
    <td>
    	<input type="text" id="email1" name="email1" class="mailId">@
    	<input type="text" id="email2" name="email2" class="mailAddress" value="" disabled>
    	<select id="email3">
...
<div class="ec-base-box typeThinBg gStrong">
    <p>
	    <span class="ec-base-chk"><input type="checkbox" id="sAgreeAllChecked" name="agree_check"><em class="checkbox"></em></span>
	    <label for="sAgreeAllChecked"><strong>이용약관 및 개인정보수집 및 이용, 수강정보 수신(선택)에 모두 동의합니다.</strong></label>
    </p>
</div>
...
<div class="ec-base-box typeThinBg agreeArea">
        ...
        <p class="check"><span>이용약관에 동의하십니까?</span> 
	        <input id="agree_service_check0" name="agree_check" value="1" type="checkbox"  />
	        <label for="agree_service_check0" >동의함</label>
	        <span id="agreeMsg1"></span>
        </p>
</div>
...
<div class="ec-base-box typeThinBg agreeArea">
        ...
        <p class="check">
        	...
        	<input id="agree_privacy_check0" name="agree_check" value="1" type="checkbox"/>
        	<label for="agree_privacy_check0" >동의함</label>
        	<span id="agreeMsg2"></span>
        </p>
</div>
