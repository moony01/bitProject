...
<c:if test="${boardDTO!=null }">
	...
	<input type="button" value="목록" onclick="location.href='/reviewProject/board/boardList.do?pg=${pg}'">
	<input type="button" value="답글" onclick="location.href='/reviewProject/board/boardReplyForm.do?pseq=${boardDTO.seq }&pg=${pg }'">             
